...
cp --preserve=timestamps -f ./vlink/vlink-0_18a-1-x86_64.pkg.tar.zst ./packages/vbcc6502_toolchain_MSYS_64bit_packages/
cp --preserve=timestamps -f ./vasm/vasm-2_0e-1-x86_64.pkg.tar.zst ./packages/vbcc6502_toolchain_MSYS_64bit_packages/
cp --preserve=timestamps -f ./vasm/vasm6502-2_0e-1-x86_64.pkg.tar.zst ./packages/vbcc6502_toolchain_MSYS_64bit_packages/
...
cp --preserve=timestamps -f ./vlink/vlink-0_18a-1-i686.pkg.tar.zst ./packages/vbcc6502_toolchain_MSYS_32bit_packages/
cp --preserve=timestamps -f ./vasm/vasm-2_0e-1-i686.pkg.tar.zst ./packages/vbcc6502_toolchain_MSYS_32bit_packages/
cp --preserve=timestamps -f ./vasm/vasm6502-2_0e-1-i686.pkg.tar.zst ./packages/vbcc6502_toolchain_MSYS_32bit_packages/
