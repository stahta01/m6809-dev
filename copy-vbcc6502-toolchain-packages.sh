...
cp --preserve=timestamps -f ./vlink/vlink-0_17a-1-x86_64.pkg.tar.zst ./packages/vbcc6502_toolchain_MSYS_64bit_packages/
...
cp --preserve=timestamps -f ./vlink/vlink-0_17a-1-i686.pkg.tar.zst ./packages/vbcc6502_toolchain_MSYS_32bit_packages/
