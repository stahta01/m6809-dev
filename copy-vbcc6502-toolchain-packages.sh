...
cp --preserve=timestamps -f ./vasm/vasm-2_0b-1-x86_64.pkg.tar.zst ./packages/vbcc6502_toolchain_MSYS_64bit_packages/
cp --preserve=timestamps -f ./vasm/vasm6502-2_0b-1-x86_64.pkg.tar.zst ./packages/vbcc6502_toolchain_MSYS_64bit_packages/
...
cp --preserve=timestamps -f ./vasm/vasm-2_0b-1-i686.pkg.tar.zst ./packages/vbcc6502_toolchain_MSYS_32bit_packages/
cp --preserve=timestamps -f ./vasm/vasm6502-2_0b-1-i686.pkg.tar.zst ./packages/vbcc6502_toolchain_MSYS_32bit_packages/
