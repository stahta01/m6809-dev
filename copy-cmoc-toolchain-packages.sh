...
cp --preserve=timestamps -f ./cmoc/cmoc-0.1.96-1-x86_64.pkg.tar.zst ./packages/cmoc_toolchain_MSYS_64bit_packages/
...
cp --preserve=timestamps -f ./cmoc/cmoc-0.1.96-1-i686.pkg.tar.zst ./packages/cmoc_toolchain_MSYS_32bit_packages/
