...
cp -f ./mingw-w64-lwtools/mingw-w64-x86_64-lwtools-4.22-1-any.pkg.tar.zst ./packages/cmoc_toolchain_mingw_64_packages/
...
cp -f ./mingw-w64-lwtools/mingw-w64-i686-lwtools-4.22-1-any.pkg.tar.zst ./packages/cmoc_toolchain_mingw_32_packages/
...
cp -f ./mingw-w64-lwtools/mingw-w64-ucrt-x86_64-lwtools-4.22-1-any.pkg.tar.zst ./packages/cmoc_toolchain_mingw_UCRT64_packages/
