...
cp -f ./gcc6809lw/gcc6809lw-4.3.6-3-x86_64.pkg.tar.zst ./packages/gcc6809lw_toolchain_MSYS_64bit_packages/
...
cp -f ./gcc6809lw/gcc6809lw-4.3.6-3-i686.pkg.tar.zst ./packages/gcc6809lw_toolchain_MSYS_32bit_packages/
