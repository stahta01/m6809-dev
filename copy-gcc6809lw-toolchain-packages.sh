...
cp --preserve=timestamps -f ./lwtools/lwtools-4.23-2-x86_64.pkg.tar.zst ./packages/gcc6809lw_toolchain_MSYS_64bit_packages/
...
cp --preserve=timestamps -f ./lwtools/lwtools-4.23-2-i686.pkg.tar.zst ./packages/gcc6809lw_toolchain_MSYS_32bit_packages/
