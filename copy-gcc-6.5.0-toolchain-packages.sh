...
cp -f ./mingw-w64-gcc6/mingw-w64-x86_64-gcc6-libs-6.5.0-3-any.pkg.tar.zst ./packages/gcc6.5.0_toolchain_mingw_64_packages/
cp -f ./mingw-w64-gcc6/mingw-w64-x86_64-gcc6-6.5.0-3-any.pkg.tar.zst ./packages/gcc6.5.0_toolchain_mingw_64_packages/
...
cp -f ./mingw-w64-gcc6/mingw-w64-i686-gcc6-libs-6.5.0-3-any.pkg.tar.zst ./packages/gcc6.5.0_toolchain_mingw_32_packages/
cp -f ./mingw-w64-gcc6/mingw-w64-i686-gcc6-6.5.0-3-any.pkg.tar.zst ./packages/gcc6.5.0_toolchain_mingw_32_packages/
...
cp -f ./mingw-w64-gcc6/mingw-w64-ucrt-x86_64-gcc6-libs-6.5.0-3-any.pkg.tar.zst ./packages/gcc6.5.0_toolchain_mingw_UCRT64_packages/
cp -f ./mingw-w64-gcc6/mingw-w64-ucrt-x86_64-gcc6-6.5.0-3-any.pkg.tar.zst ./packages/gcc6.5.0_toolchain_mingw_UCRT64_packages/
